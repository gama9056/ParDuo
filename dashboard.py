...
# ========== TÍTULO ==========
st.markdown("""
    <h1 style="color: black; margin-top: -55px; text-align: center; font-size: 48px; 
    font-family: 'Arial; text-shadow: 2px 2px 4px rgba(0,0,0,0.1); letter-spacing: 2px">😎 ParDuo</h1>
